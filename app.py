...
_ETFS_POR_SECTOR = {
    "🌐 Mercado Amplio EE.UU.": [
        ...
        {"ticker": "VOO",  "familia": "Vanguard",     "nombre": "Vanguard S&P 500 ETF",
         "composicion": "S&P 500 de Vanguard: fee entre los más bajos del mercado (0.03%). Activos superiores a $1 billón. Preferido por inversores pasivos a largo plazo."},
        ...
        {"ticker": "MOAT", "familia": "VanEck",       "nombre": "VanEck Morningstar Wide Moat ETF",
         "composicion": "~50 empresas con ventajas competitivas sostenibles ('foso económico amplio') según Morningstar. Rebalanceo trimestral. Historial de superar al S&P 500 a largo plazo."},
    ],
    "💻 Tecnología": [
        ...
        {"ticker": "SMH",  "familia": "VanEck",       "nombre": "VanEck Semiconductor ETF",
         "composicion": "Los 25 mayores fabricantes de semiconductores globales. NVDA, TSM y ASML son posiciones clave. Menor expense ratio que SOXX para la misma exposición al sector."},
        {"ticker": "IGV",  "familia": "iShares",      "nombre": "iShares Expanded Tech-Software ETF",
         "composicion": "Software y servicios cloud: MSFT, ORCL, ADBE, CRM, INTU. Exposición pura a SaaS, software empresarial y ciberseguridad. Ingresos recurrentes de alto margen."},
        {"ticker": "CIBR", "familia": "First Trust",  "nombre": "First Trust NASDAQ Cybersecurity ETF",
         "composicion": "Ciberseguridad: Palo Alto, CrowdStrike, Fortinet, Check Point. Beneficiado por el aumento estructural del gasto en seguridad digital y ransomware."},
    ],
    "🏦 Servicios Financieros": [
    ...
    "🏥 Salud": [
        ...
        {"ticker": "XBI",  "familia": "State Street", "nombre": "SPDR S&P Biotech ETF",
         "composicion": "Biotech de ponderación equitativa. Más exposición a small y mid caps que IBB. Mayor volatilidad pero también mayor potencial en aprobaciones de medicamentos."},
        {"ticker": "ARKG", "familia": "ARK Invest",   "nombre": "ARK Genomic Revolution ETF",
         "composicion": "Genómica, edición génica, bioinformática e inmunooncología. Gestión activa (Cathie Wood). Alta concentración y volatilidad; perfil especulativo/innovación disruptiva."},
    ],
    "⚡ Energía": [
        ...
        {"ticker": "AMLP", "familia": "Alerian",      "nombre": "Alerian MLP ETF",
         "composicion": "Master Limited Partnerships (MLPs) de energía: oleoductos, gasoductos y almacenamiento. Altos dividendos (>7%). Estructura tributaria diferente; revisar implicaciones fiscales."},
    ...
    "🛍️ Consumo Discrecional": [
        ...
        {"ticker": "JETS", "familia": "U.S. Global",  "nombre": "U.S. Global Jets ETF",
         "composicion": "Aerolíneas y aviación global: AAL, DAL, UAL, LUV, Southwest, Ryanair. Alta sensibilidad al precio del combustible y demanda de viajes. Perfil cíclico pronunciado."},
    ...
    "🏭 Industriales": [
        ...
        {"ticker": "ROBO", "familia": "ROBO Global",  "nombre": "ROBO Global Robotics & Automation ETF",
         "composicion": "Robótica, automatización e inteligencia artificial industrial: Fanuc, ABB, Cognex, Rockwell. Exposición global. Tema secular de la Industria 4.0."},
    ],
    "🏠 Real Estate": [
    ...
    "📡 Comunicaciones": [
        ...
        {"ticker": "FCOM", "familia": "Fidelity",     "nombre": "Fidelity MSCI Communication Services ETF",
         "composicion": "Servicios de comunicación según MSCI. Fee entre los más bajos del sector. Alternativa a XLC con exposición global y menor concentración en META/GOOGL."},
    ],
    "🌍 Internacional Desarrollado": [
        ...
        {"ticker": "EWJ",  "familia": "iShares",      "nombre": "iShares MSCI Japan ETF",
         "composicion": "Japón: Toyota, Sony, SoftBank, Nintendo. Segunda economía de Asia. Exposición al yen; sensible a política monetaria del Banco de Japón y exportaciones."},
    ...
    "🌏 Mercados Emergentes": [
        ...
        {"ticker": "VNM",  "familia": "VanEck",       "nombre": "VanEck Vietnam ETF",
         "composicion": "Vietnam: una de las economías de Asia de mayor crecimiento. Manufactura, consumo doméstico y digitalización. Alternativa emergente de bajo costo con alto potencial."},
    ],
    "📊 Renta Fija": [
    ...
    "🥇 Materias Primas": [
        ...
        {"ticker": "DBC",  "familia": "Invesco",      "nombre": "Invesco DB Commodity Index Tracking Fund",
         "composicion": "Canasta diversificada: energía (~55%), metales (~25%) y agricultura (~20%). El ETF de commodities más líquido y diversificado. Exposición táctica a materias primas."},
